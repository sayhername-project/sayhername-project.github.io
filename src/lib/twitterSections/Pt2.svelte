...
<Scroller layout="right">
    ...
    {#snippet scrolly()}   
        ...
        <ArticleText>
            ...
            <br/><br/>
            These hashtag pairings indicate that users were not simply sharing isolated stories, but actively building a collective counter-narrative about the impact of state violence on the intersectionality of gender and race.
        </ArticleText>
