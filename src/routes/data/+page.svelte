...
<main class="">
	...
	<section class="bg-linear-to-b from-pink-950 to-red-950 px-6 py-30">
		<div class="mx-auto max-w-4xl">
			<h2 class="mb-8 text-center text-4xl text-white md:text-5xl">Citations</h2>
			<div class="space-y-6 text-lg leading-relaxed text-gray-300 md:text-xl">
				<ul class="list-disc">
					<li>
						African American Policy Forum. (n.d.). <i>#SayHerName.</i>
						<a
							href="https://www.aapf.org/sayhername"
							class="text-purple-300"
							style="text-decoration: underline;">https://www.aapf.org/sayhername.</a
						>
					</li>
					<li>
						Clemm von Hohenberg, B., Menchen-Trevino, E., Casas, A., Wojcieszak, M. (2021). <i
					...
					<li>
						Crenshaw, Kimberlé, and African American Policy Forum, authors. <i
							>#SayHerName: Black Women’s Stories of Police Violence and Public Silence.</i
						> Foreword by Janelle Monáe. Haymarket Books, 2023.
					</li>
					<li>
						Jackson, S. J., Bailey, M., & Foucault Welles, B. (2020). <i
							>#HashtagActivism: Networks of race and gender justice.</i
						> The MIT Press.
					</li>
					<li>
						Kaufman, M.R., Wright, K., Shin, R. <i>et al.</i> The power of social media activism in
						the #YesAllWomen Movement. <i>Humanit Soc Sci Commun</i> 12, 1469 (2025).
						<a
							href="https://doi.org/10.1057/s41599-025-05647-5"
							class="text-purple-300"
							style="text-decoration: underline;">https://doi.org/10.1057/s41599-025-05647-5.</a
						>
					</li>
					<li>
						Korr, Vadim. (2023). svelte-carousel [Computer software]. GitHub. <a
							href="https://github.com/vadimkorr/svelte-carousel"
							class="text-purple-300"
							style="text-decoration: underline;">https://github.com/vadimkorr/svelte-carousel.</a
						> (Accessed December 7, 2025).
					</li>
					<li>
						Media Cloud team. <i
							>Coverage analysis of Black women’s stories of police violence using the #SayHerName
							framework, 2015.</i
						>
						Media Cloud, Accessed 7 Dec. 2025,
						<a href="www.mediacloud.org" class="text-purple-300" style="text-decoration: underline;"
							>www.mediacloud.org</a
						>
					</li>
					<li>
						Nguyen, T., Vu, X.-S., & Nguyen, M.-T. (2020). <i
							>BERTweet: A pre-trained language model for English Tweets</i
						>
						[Computer software]. Hugging Face.
						<a
							href="https://huggingface.co/vinai/bertweet-base"
							class="text-purple-300"
							style="text-decoration: underline;">https://huggingface.co/vinai/bertweet-base.</a
						>
					</li>
					<li>
						Riebesell, Janosh. (2025). svelte-toc [Computer software]. GitHub. <a
							href="https://github.com/janosh/svelte-toc"
							class="text-purple-300"
							style="text-decoration: underline;">https://github.com/janosh/svelte-toc.</a
						> (Accessed December 7, 2025).
					</li>
				</ul>
			</div>
